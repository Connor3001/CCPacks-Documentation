...
`sprite_location` | [Identifier](identifier.md) | `"origins:textures/gui/resource_bar.png"` | The path to the file in the assets which contains what the bar looks like.
...
This definition shows the resource/cooldown as a white bar with a bone icon (If Origins is installed).
